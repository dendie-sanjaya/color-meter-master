    ...
    <div class="page-content header-clear-small">        
        <div data-height="130" class="caption caption-margins round-medium shadow-huge">
            <div class="caption-center right-15 top-15 text-right">
                <a href="{{ url('colorPattern/edit/0') }}" class="back-button button button-xs button-round-huge bg-highlight">Add Pattern Color</a>
            </div>
	        		...
	        		<?php foreach($data as $val): ?>
		                ...
		                <p id="accordion-content-<?php echo $i ?>" class="accordion-content bottom-10">
	                        ...
	                        <span class="text-right">
		                       <a href="{{ url('colorPattern/edit/'.$val->id) }}" data-menu="menu-confirm"><i class="fa fa-edit color-white2-dark"></i></a> 
...
@section('js')
  <script type="text/javascript">
  	function confirmDelete(p) {
  	   $('#link-delete').attr("href", '<?php echo url('colorPattern/delete/') ?>/' + p + '?rand=<?php echo rand(100,100000) ?>');
  	}

  	$("#link-delete").click(function(){ window.location = '<?php echo url('colorPattern') ?>'+'?rand=<?php echo rand(100,100000) ?>'});
