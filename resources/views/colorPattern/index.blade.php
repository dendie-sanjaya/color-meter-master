    ...
    <div class="page-content header-clear-small">        
        <div data-height="130" class="caption caption-margins round-medium shadow-huge">
            <div class="caption-center right-15 top-15 text-right">
                <a href="javascript:window.location='{{ url('colorGrade/edit/0') }}'" class="back-button button button-xs button-round-huge bg-highlight">Add Pattern Color</a>
            </div>
	        		...
	        		<?php foreach($data as $val): ?>
		                ...
		                <p id="accordion-content-<?php echo $i ?>" class="accordion-content bottom-10">
	                        ...
	                        <span class="text-right">
		                       ...
		                       <a href="#" onclick="confirmDelete('{{ url('colorPattern/delete/'.$val->id) }}')" data="{{ $val->id }}" data-menu="menu-confirm"><i class="fa fa-trash color-white2-dark"></i></a> 
	                   	    </span>
		                </p> 
		            <?php $i++ ?>    
		            <?php endforeach ?>    
