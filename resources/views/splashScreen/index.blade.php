  ...
  <div id="page">
    ...
    <div class="page-content">  
        ...
        <div class="cover-wrapper cover-has-buttons">    
            <a href="{{ url('dashboard') }}" class="cover-button button button-round-huge shadow-large button-full bg-green1-dark left-40 right-40 button-m scale-box">GET STARTED HERE</a>
            <!--
...
@section('js')
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        document.cookie = "integria-scan-color=integria-scan-color;path=/;secure";  
